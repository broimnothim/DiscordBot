...
const isValidSnowflake = (v) => !!v && /^\d{17,20}$/.test(v) && !/^0+$/.test(v);
...
async function main() {
    ...
    const commands = [
        new SlashCommandBuilder()
            ...
            .addChannelOption((opt) => opt.setName('channel').setDescription('Canale di testo destinazione').setRequired(true))
            .addStringOption((opt) => {
            const o = opt
                .setName('panel_id')
        ...
        new SlashCommandBuilder()
            ...
            .addChoices({ name: 'Primary', value: 'Primary' }, { name: 'Secondary', value: 'Secondary' }, { name: 'Success', value: 'Success' }, { name: 'Danger', value: 'Danger' })
            .setRequired(true))
        ...
        new SlashCommandBuilder()
            ...
            .addStringOption((opt) => opt.setName('reason').setDescription('Motivo della chiusura').setRequired(false))
            .toJSON(),
        new SlashCommandBuilder()
            .setName('adduser')
